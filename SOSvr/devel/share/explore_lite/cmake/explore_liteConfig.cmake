...
if("TRUE" STREQUAL "TRUE")
  set(explore_lite_SOURCE_PREFIX /home/user/workspace/sos/SOSvr/src/explore)
  set(explore_lite_DEVEL_PREFIX /home/user/workspace/sos/SOSvr/devel)
  ...
  set(explore_lite_INSTALL_PREFIX /home/user/workspace/sos/SOSvr/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'explore_lite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/workspace/sos/SOSvr/src/explore/${idir}'.  Ask the maintainer 'Jiri Horner <laeqten@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${explore_lite_dep}_FOUND)
      find_package(${explore_lite_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${explore_lite_dep} REQUIRED ${depend_list})
  endif()
