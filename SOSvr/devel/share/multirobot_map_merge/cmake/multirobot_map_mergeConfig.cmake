...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/user/workspace/sos/SOSvr/src/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/user/workspace/sos/SOSvr/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/user/workspace/sos/SOSvr/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/workspace/sos/SOSvr/src/map_merge/${idir}'.  Ask the maintainer 'Jiri Horner <laeqten@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/user/workspace/sos/SOSvr/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${multirobot_map_merge_dep}_FOUND)
      find_package(${multirobot_map_merge_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${multirobot_map_merge_dep} REQUIRED ${depend_list})
  endif()
