...
int main(int argc, char** argv){
  ...
  // odom_trans_two.child_frame_id = "odom";
  ros::Rate r(150);
  while(n.ok()){
    ...
    //odom_trans_two.transform.translation.x = mydata.pose.pose.position.x;
    //odom_trans_two.transform.translation.y = mydata.pose.pose.position.y;
    //odom_trans_two.transform.translation.z = mydata.pose.pose.position.z;
    //odom_trans_two.transform.rotation= mydata.pose.pose.orientation;
